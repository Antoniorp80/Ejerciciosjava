 ...
 * introducimos el 2 y el 5, se deberán mostrar 2^1,2^2,2^3,2^4,2^5.
 * @author Antonio R.P.
 */
public class Bucles15 {
  public static void main(String[] args) {
    ...
    int exponenteDado = Integer.parseInt(System.console().readLine());

    double potencia;
    int exponente;
        
    for (int i = 1; i <= exponenteDado; i++) {
