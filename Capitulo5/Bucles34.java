...
public class Bucles34 {
  public static void main(String[] args) {
    System.out.println("Programa que mezcla los digitos pares y los impares respectivamente de dos números introducidos: ");
    System.out.println("Recuerde que los números introducidos deben tener la misma longitud: "); 
