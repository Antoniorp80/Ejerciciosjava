...
public class Aleatorio20 {
  public static void main(String[] args) {
    ...
    System.out.print("Por favor, indique cuántos litros tiene la cuba: ");
    ...
    System.out.print("La capacidad de la cuba es de " + capacidad);
    System.out.print("Contiene " + litros + " litros de agua.");
  }
}
