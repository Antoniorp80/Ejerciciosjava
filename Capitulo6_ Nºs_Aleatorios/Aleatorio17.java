 ...
 */
public class Aleatorio17 {
  public static void main(String[] args) {

    System.out.print("Por favor, introduzca la altura (al menos 4): ");
    int alto = Integer.parseInt(System.console().readLine());

    System.out.print("Ahora introduzca la anchura (al menos 4): ");
    ...
    for(int i = 2; i < alto; i++) {
      ...
      for(int j = 2; j < ancho; j++) {
        if (posicion == posicionPez) { //pinta el pez//
          System.out.print("&");
        } else {
          System.out.print(" ");
        }
